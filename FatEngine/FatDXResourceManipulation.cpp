...
namespace FatDx
{
    ComPtr<ID3D12Resource> CreateUploadBuffer (ComPtr<ID3D12Device> device, const UINT64 &  bufferSize) {
        ...
        HRESULT res  = device->CreateCommittedResource (&uploadHeapProperties, D3D12_HEAP_FLAG_NONE,
